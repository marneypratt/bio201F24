...
#library(flextable, warn.conflicts = FALSE) ## for making formatted tables that can be pasted into Word or Google Docs
...
library(ggpubr, warn.conflicts = FALSE) #publication ready plots
